...
<Head>
  <title>{'Localization/i18n Guide - Material React Table V3 Docs'}</title>
  <meta
    name="description"
...
> If your language is not yet supported, please consider making a PR to add it to the library! See [here on GitHub](https://github.com/KevinVandy/material-react-table/tree/v3/packages/material-react-table/src/locales).
