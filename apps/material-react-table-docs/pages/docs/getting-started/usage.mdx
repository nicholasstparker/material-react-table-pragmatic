...
To start using MaterialReactTable, you first need to [install](/docs/getting-started/install) `material-react-table` and the necessary Material UI V6 dependencies.
